...
export default function HeadNavBar({ path = '' }) {
    ...
    return (
        <>
            ...
            <nav className="flex flex-initial justify-right bg-gradient-to-tr from-white via-transparent to-black/60">
                <form className="relative w-2/3 m-2 ml-20 items-right ">
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder={searchPlaceholder} required />
